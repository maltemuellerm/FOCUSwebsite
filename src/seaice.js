...
var sstartDate = new Date(currentTime.getTime());
L.TimeDimension.Util.addTimeDuration(endDate, "P7D", true);
L.TimeDimension.Util.subtractTimeDuration(sstartDate, "P7D", true);
...
//    crs: L.CRS.EPSG4326, 
    ...
    timeDimensionOptions: {
        ...
        timeInterval: sstartDate.toISOString() +"/"+ endDate.toISOString(),
        period: "P1D",
        //period: "PT1H",
...
var arcdriftWMS = "http://thredds.met.no/thredds/wms/metusers/maltem/SALIENSEAS/ARCMFC/ARCMFC-icedrift-latest.nc";
...
var ARCdriftTimeLayer =
      L.tileLayer.wms(arcdriftWMS, {
      layers: 'icedrift',
      format: 'image/png',
      transparent: true,
      abovemaxcolor: "extend",
...
//    "Sea Ice  - sea ice edge": SARLayer,
    "Sea-ice chart (concentration)": SARconcTimeLayer,
    "Sea-ice forecast (sea-ice edge)": ARCedgeTimeLayer,
    "Sea-ice chart (sea ice edge)": SARedgeTimeLayer,
    "Sea-ice drift ": ARCdriftTimeLayer
};
...
testLegend.onAdd = function(map) {
    var src = sariceWMS + "?SERVICE=WMS&VERSION=1.3.0&REQUEST=GetLegendGraphic&LAYER=ice_concentration&PALETTE=wmo_ice_chart&numcolorbands=10&colorscalerange=0,100";
